...
# Jaccard Distance (Second implementation)
def sim_jaccard2(prefs, person1, person2):

    #Get the list of items
    person1_movies = prefs[person1].keys()
    person2_movies = prefs[person2].keys()

    # Make them sets in order to be able to use built-in methods of it such as intersection and union
    p1, p2 = set(person1_movies), set(person2_movies)
